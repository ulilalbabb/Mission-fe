    ...
    return (
        <footer className="bg-navbar flex flex-col lg:flex-row justify-between p-5 gap-5 text-white">
            ...
            <div className="flex flex-col justify-center">
                ...
                <img className="lg:hidden sm:block absolute right-5 bottom-[-151.5%]" src="../assets/arrow-footer.png" alt="" />
            ...
            <div className="mr-10">
                ...
                <img src="../assets/arrow-footer.png" alt="" className="lg:hidden sm:block absolute bottom-[-157.5%] right-5 "/>
                <ul className=" list-none hidden lg:block">
